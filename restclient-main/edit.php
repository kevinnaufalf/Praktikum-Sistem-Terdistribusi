...
$response = $client->request('GET', '/api/idbarang/', 
['json' => [
    'id' => $id,
]]);
            ...
            <div class="table-wrapper">
                ...
                <form action="edit_data.php?id=<?php echo $id?>" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input nama="text" class="form-control" id="spek" name="spek" value="<?php echo $data_body->spek ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="jumlah" class="form-label">Jumlah</label>
                        <input nama="text" class="form-control" id="jumlah" name="jumlah" value="<?php echo $data_body->jumlah ?>" required>
                    </div>
                    <div class="mb-3">
