...
$response =  $client->request('GET', '/api/barang');
        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-5">
                            <h2>Daftar <b>Jual Beli</b></h2>
                        </div>
                        <div class="col-sm-7">
                            <a href="add.php" class="btn btn-secondary"><span class="material-icons-outlined">Tambah Data</span></a>
                        </div>
                        <div class="col-sm-7">
                            <a href="index2.php" class="btn btn-secondary"><span class="material-icons-outlined">Data Service</span></a>
                        </div>
                    </div>
                </div>
