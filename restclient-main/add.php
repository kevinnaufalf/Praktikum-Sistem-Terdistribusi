                ...
                <div class="table-wrapper">
                    ...
                    <form action="add_data.php" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="text" name="spek" id="spek" class="form-control" required></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="jumlah" class="form-label">Jumlah</label>
                            <textarea type="text" name="jumlah" id="jumlah" class="form-control" required></textarea>
                        </div>
                        <div class="mb-3">
